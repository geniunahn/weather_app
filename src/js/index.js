...
function getWeatherData(cityname) {
  ...
  fetch(API_URL)
    ...
    .then(function (data) {
      ...
      tempMaxMinEl2.innerHTML = `${tempMax - 2} / ${tempMin - 1}`;
      tempMaxMinEl3.innerHTML = `${tempMax - 3} / ${tempMin - 3}`;
      tempMaxMinEl4.innerHTML = `${tempMax - 1} / ${tempMin}`;
      tempMaxMinEl5.innerHTML = `${tempMax + 1} / ${tempMin + 1}`;
      tempMaxMinEl6.innerHTML = `${tempMax} / ${tempMin - 1}`;
      tempMaxMinEl7.innerHTML = `${tempMax - 1} / ${tempMin - 3}`;
      tempMaxMinEl8.innerHTML = `${tempMax - 2} / ${tempMin - 3}`;
      ...
      function wIcon(weather_icon) {
        ...
        var w_icon_src_arr = [
          "./src/images/clear_sky_d.svg",
          "./src/images/clear_sky_n.svg",
          "./src/images/few_clouds_d.svg",
          "./src/images/few_clouds_n.svg",
          "./src/images/scattered_clouds_d.svg",
          "./src/images/scattered_clouds_n.svg",
          "./src/images/broken_clouds_d.svg",
          "./src/images/broken_clouds_n.svg",
          "./src/images/shower_rain_d.svg",
          "./src/images/shower_rain_n.svg",
          "./src/images/rain_d.svg",
          "./src/images/rain_n.svg",
          "./src/images/thunderstorm_d.svg",
          "./src/images/thunderstorm_n.svg",
          "./src/images/snow_d.svg",
          "./src/images/snow_n.svg",
          "./src/images/mist_d.svg",
          "./src/images/mist_n.svg",
        ];
      ...
      function video(weather) {
        ...
        var video_src_arr = [
          "./src/video/clear_sky.mp4",
          "./src/video/clear_sky.mp4",
          "./src/video/few_clouds.mp4",
          "./src/video/few_clouds.mp4",
          "./src/video/scattered_clouds.mp4",
          "./src/video/scattered_clouds.mp4",
          "./src/video/broken_clouds.mp4",
          "./src/video/broken_clouds.mp4",
          "./src/video/shower_rain.mp4",
          "./src/video/shower_rain.mp4",
          "./src/video/rain.mp4",
          "./src/video/rain.mp4",
