...
function getWeatherData(cityname) {
  ...
  fetch(API_URL)
    ...
    .then(function (data) {
      ...
      tempEl3.innerHTML = `${temp - 3}&deg`;
      tempEl4.innerHTML = `${temp - 4}&deg`;
      tempEl5.innerHTML = `${temp - 4}&deg`;
      ...
      tempMaxMinEl2.innerHTML = `${tempMax - 1} / ${tempMin - 2}`;
      tempMaxMinEl3.innerHTML = `${tempMax - 3} / ${tempMin - 4}`;
      tempMaxMinEl4.innerHTML = `${tempMax - 2} / ${tempMin - 2}`;
      tempMaxMinEl5.innerHTML = `${tempMax - 1} / ${tempMin - 1}`;
      tempMaxMinEl6.innerHTML = `${tempMax + 1} / ${tempMin + 1}`;
      tempMaxMinEl7.innerHTML = `${tempMax + 2} / ${tempMin + 1}`;
      tempMaxMinEl8.innerHTML = `${tempMax + 3} / ${tempMin + 2}`;
