...
function getWeatherData(cityname) {
  ...
  fetch(API_URL)
    ...
    .then(function (data) {
      ...
      tempMaxMinEl3.innerHTML = `${tempMax - 2} / ${tempMin - 4}`;
      tempMaxMinEl4.innerHTML = `${tempMax - 4} / ${tempMin - 3}`;
      tempMaxMinEl5.innerHTML = `${tempMax - 2} / ${tempMin - 1}`;
      tempMaxMinEl6.innerHTML = `${tempMax + 1} / ${tempMin}`;
      tempMaxMinEl7.innerHTML = `${tempMax + 2} / ${tempMin - 1}`;
      tempMaxMinEl8.innerHTML = `${tempMax} / ${tempMin - 2}`;
